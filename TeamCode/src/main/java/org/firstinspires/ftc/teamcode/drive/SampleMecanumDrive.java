...
public class SampleMecanumDrive extends MecanumDrive {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(13.5, 0, 0);//
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(13.5, 0, 0);//

    public static double LATERAL_MULTIPLIER = 1;
    public static double angularError = 0.25;
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap) {
        ...
        follower = new HolonomicPIDVAFollower(TRANSLATIONAL_PID, TRANSLATIONAL_PID, HEADING_PID,
                new Pose2d(0.5, 0.5, Math.toRadians(angularError)), 0.5);
        ...
        leftFront = hardwareMap.get(DcMotorEx.class, "frontLeft"); //0
